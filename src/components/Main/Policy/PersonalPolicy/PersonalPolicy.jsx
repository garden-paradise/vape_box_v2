...
import style from './PersonalPolicy.module.css';

const PersonalPolicy = () => {
  let myCompany = 'ООО ВЕКСЕЛЬ ГРУПП';
  let mySite = 'https://h5russia.com';
  let mySiteUrl = 'https://h5russia.com/personal_policy';
  let myEmail = 'ceo@hi5russia.com';
  return (
    <footer className={style.personalPolicy}>
      <div className={style.personalPolicy_container}>
        <section className={style.footer_argo}>
          ...
          <div>
            ...
            <div className={style.personalPolicy_subtitle}>
              <div>
            ...
            <div>
              ...
              <div className={style.personalPolicy_subtitle}>
                ...
                <div>
                  ...
                  Оператора <a href=''>{myEmail}</a> с пометкой «Актуализация
                  персональных данных».
                </div>
                <div>
                  ...
                  почты на электронный адрес Оператора <a href=''>{myEmail}</a>{' '}
